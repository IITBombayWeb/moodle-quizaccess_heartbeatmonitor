...
$url = new moodle_url('/mod/quiz/accessrule/heartbeatmonitor/showoverrides.php', array('cmid'=>$cm->id, 'mode'=>$mode));
...
if ($groupmode) {
    ...
    echo $OUTPUT->single_button($heartbeatmonitorurl->out(true,
